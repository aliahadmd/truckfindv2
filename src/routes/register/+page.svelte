<div class="flex flex-col items-center h-full w-full">
	...
	<form action="?/register" method="POST" class="flex flex-col items-center space-y-2 w-full pt-4">
		...
		<div class="form-control w-full max-w-md">
			<label for="phone_number" class="label font-medium pb-1">
				<span class="label-text">Phone Number</span>
			</label>
			<input type="text" name="phone_number" class="input input-bordered w-full max-w-md" />
		</div>
		<div class="form-control w-full max-w-md">
			<label for="vat" class="label font-medium pb-1">
				<span class="label-text">Vat</span>
			</label>
			<input type="text" name="vat" class="input input-bordered w-full max-w-md" />
		</div>
		<div class="form-control w-full max-w-md">
